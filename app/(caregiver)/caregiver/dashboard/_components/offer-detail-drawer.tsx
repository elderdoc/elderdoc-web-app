...
import { X, MapPin, Clock, Sparkles, ArrowRight, FileText } from 'lucide-react'
              ...
              {offer.description && (
                <div className="rounded-[14px] border border-border bg-muted/20 p-4">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <p className="text-[12.5px] font-semibold text-muted-foreground uppercase tracking-wider">About this role</p>
                  </div>
                  <p className="text-[13.5px] text-foreground/80 leading-relaxed whitespace-pre-line">{offer.description}</p>
                </div>
              )}
