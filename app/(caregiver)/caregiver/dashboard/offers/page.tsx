...
import { caregiverProfiles, matches, careRequests, careRequestLocations, careRecipients } from '@/db/schema'
        ...
        <div className="space-y-4">
          {offers.map((offer) => {
            ...
            return (
              <OfferDetailDrawer
                key={offer.matchId}
                offer={{ ...offer, title, careTypeLabel: CARE_TYPE_LABELS[offer.careType] ?? offer.careType, description: offer.description ?? null }}
              />
            )
          })}
        </div>
