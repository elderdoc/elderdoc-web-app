        ...
        <div className="space-y-3">
          {requests.map((req) => {
            ...
            const job = {
              ...req,
              title,
              careTypeLabel: CARE_TYPE_LABELS[req.careType] ?? req.careType,
              recipientName: toInitials(req.recipientName),
              clientName: toInitials(req.clientName),
              address1: null,
            }
                ...
                <div className="flex items-start justify-between gap-4">
                  <div className="min-w-0 flex-1 space-y-2.5">
                    ...
                    <div className="flex flex-wrap gap-x-4 gap-y-1 text-[12.5px] text-muted-foreground">
                      ...
                      {req.recipientName && <span>For {toInitials(req.recipientName)}</span>}
