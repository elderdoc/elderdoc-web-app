...
import {
  CERTIFICATIONS, LANGUAGES, WORK_TYPES,
...
export function CaregiverProfileForm({ profile: p, careTypes }: { profile: Profile; careTypes: { key: string; label: string }[] }) {
        ...
        <div className="rounded-[18px] border border-border bg-card p-5">
          ...
          <div className="space-y-3.5">
            <div className="grid grid-cols-2 gap-3">
              ...
              <div>
                <label className={labelClass}>Max rate ($/hr) <span className="normal-case font-normal text-muted-foreground/60">(optional)</span></label>
                <input type="number" value={form.hourlyMax} onChange={e => setForm(f => ({ ...f, hourlyMax: e.target.value }))} className={inputClass} placeholder="Leave blank for no max" />
              </div>
            </div>
            <div>
              <label className={labelClass}>
      ...
      <div className="rounded-[18px] border border-border bg-card p-5">
        ...
        <div className="space-y-3.5">
          ...
          <div>
            ...
            <input type="text" inputMode="numeric" maxLength={10} value={form.zip} onChange={e => setForm(f => ({ ...f, zip: e.target.value }))} className={inputClass} placeholder="12345" />
          </div>
        </div>
      </div>
