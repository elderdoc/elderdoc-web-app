...
import { MapPin, Heart, Users, CalendarDays, ClipboardList, Settings2, BookOpen, Sparkles, DollarSign, Repeat, Sun, Clock, User, Car, Navigation, Check, CalendarCheck, Globe } from 'lucide-react'
...
export function NewRequestForm({ initialRecipients, initialRecipientId, avgRatesByCareType, activeCareTypes }: Props) {
  ...
  return (
    <div className="px-6 md:px-8 py-10 md:py-14 max-w-2xl mx-auto">
          ...
          {activeCareTypes.map((ct) => {
            ...
            return (
              <button
                ...
                type="button"
                onClick={() => {
                  if (ct.key === 'specialty-skills') { setShowSpecialtyModal(true); return }
                  toggleMulti('careTypes', ct.key)
                }}
                className={[
                ...
                <div className="relative">
                  <div className="flex items-start justify-between gap-3 mb-3">
                    <div className={[
                      ...
                      <CareTypeIcon iconName={ct.icon} className="h-4 w-4" />
                    </div>
                    {selected && (
                  ...
                  {ct.description && <p className="mt-1 text-[12.5px] text-muted-foreground leading-snug">{ct.description}</p>}
                </div>
              </button>
            )
          })}
      ...
      {step === 8 && (
        <div className="space-y-6">
          ...
          <div className="rounded-[10px] border border-amber-200 bg-amber-50 px-4 py-3 flex items-start gap-2.5">
            <svg width="15" height="15" viewBox="0 0 24 24" fill="none" className="shrink-0 mt-0.5 text-amber-600">
              <path d="M12 9v4m0 4h.01M10.29 3.86L1.82 18a2 2 0 001.71 3h16.94a2 2 0 001.71-3L13.71 3.86a2 2 0 00-3.42 0z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
            <p className="text-[12.5px] text-amber-800 leading-relaxed">
              <span className="font-semibold">Privacy tip:</span> Do not include your address, phone number, or other personal information here. Full details are only shared once a match is established.
            </p>
          </div>
          <div>
      ...
      {/* Specialty Skills contact modal */}
      {showSpecialtyModal && (
        <div
        ...
        >
          <div
            className="bg-background rounded-2xl border border-border shadow-xl w-full max-w-md p-7 space-y-5"
            onClick={(e) => e.stopPropagation()}
          >
            <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-[var(--forest-soft)]">
              <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className="text-[var(--forest-deep)]">
                <path d="M22 12h-4l-3 9L9 3l-3 9H2" />
              </svg>
            </div>
            <div>
              <h2 className="text-[20px] font-semibold tracking-tight">Specialty Skills Required</h2>
              <p className="mt-2 text-[13.5px] text-muted-foreground leading-relaxed">
                Services like G-Tube Feeding, Catheter Care, Tracheotomy Care, Wound Care, and Medication Administration require specialized caregivers. Please contact our live office to be matched with a qualified specialist.
              </p>
            </div>
            <div className="rounded-[14px] border border-border bg-muted/30 p-4 space-y-2.5">
              <p className="text-[11px] font-semibold uppercase tracking-widest text-muted-foreground">Contact Ambassadors Caregivers</p>
              <a href="tel:7135212221" className="flex items-center gap-2.5 text-[14px] font-medium text-foreground hover:text-primary transition-colors">
                <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07A19.5 19.5 0 013.07 10.8 19.79 19.79 0 0116.92 2a2 2 0 012 2.18v3a2 2 0 01-1.49 1.95l-1.42.36a16 16 0 01-6.8 6.8l-.36 1.42A2 2 0 0116.92 19z" />
                </svg>
                713.521.2221
              </a>
              <a href="mailto:Info@ambassadorscare.com" className="flex items-center gap-2.5 text-[14px] font-medium text-foreground hover:text-primary transition-colors">
                <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z" />
                  <polyline points="22,6 12,13 2,6" />
                </svg>
                Info@ambassadorscare.com
              </a>
            </div>
            <button
              type="button"
