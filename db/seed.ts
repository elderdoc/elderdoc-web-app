    ...
    for (const req of reqs) {
      const [request] = await db
        ...
        .values({
          ...
          transportationNeeded: req.careType === 'mobility-assistance' || req.careType === 'companionship',
          clientStatus: {
