...
export function CaregiverCard({
  caregiver, careTypeLabels, rank, onSendOffer, viewProfileHref, isFavorited, onToggleFavorite,
  ...
  const resolvedCareTypeLabels = caregiver.careTypes.map(
    key => careTypeLabels[key] ?? key
  )
